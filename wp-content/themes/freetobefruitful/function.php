...
function freetobefruitful_enqueue_styles() {
    wp_enqueue_style('style', get_stylesheet_directory_uri() . '/style.css', [], filemtime(get_template_directory() . '/style.css'));
    wp_enqueue_style('tailwind', get_stylesheet_directory_uri() . '/tailwind.css', [], filemtime(get_template_directory() . '/tailwind.css'));
}
